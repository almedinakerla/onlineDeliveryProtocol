...
import onlineDeliveryProtocol.Items;
...
public class Client extends FSM implements IFSM {
    ...
    static int LOGINED_USER 			= 7;
    static int REVIEW_ITEM_LISTS_USER 	= 8;
    static int VIEW_PRODUCTS	 		= 9;
    static int VIEW_SORTED_PRODUCTS 	= 10;
    static int VIEW_AVAILABLE_PRODUCTS 	= 11;
    static int ORDER 					= 12;
    static int WRITE_FEEDBACK 			= 13;
    static int VIEW_FEEDBACK 			= 14;
    ...
    public void orderAvailableItem(IMessage message){
        Message msg = (Message) message;
        msg.setToId(5);
        System.out.println("NaruÄ�i item: ");
